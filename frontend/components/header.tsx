...
const NavItems = ({ items }: { items: { name: string; href: string }[] }) => {
    return (
...
const FloatingNavPill = ({ isScrolled, menuItems, t }: { isScrolled: boolean; menuItems: { name: string; href: string }[]; t: ReturnType<typeof useTranslations> }) => {
    return (
        <motion.div
            animate={{
